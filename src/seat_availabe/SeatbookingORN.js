/*
  ...
  all the locker selecteions, deselection, now of hours, locker booking passcode generation, 
  amount everything  will be in this single page
...
import allLocks from "./LockersJson/allLocks.json";
