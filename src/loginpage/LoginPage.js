    ...
    fetch(/*sendOtpUrl*/ serverUrl.path, {
      ...
      .then((data) => {
        ...
        if (
          ...
          alert("some error occured, please check your mobile number");
                    ...
                    >
                      ...
                      <DialogContent>
                        <DialogContentText color={"#000"}>
                          ...
                          Please read these User Terms ("Terms") carefully
                          before using the Application and Service operated by
                          Tuckit ("us", "we", or "our"). Your access to and use
                          of the Application and Service is conditioned on your
                          ...
                          dashboards, web applications, interactive user
                          interface, hardware and related documentation which
                          Tuckit provides to the User, including any updates
                          thereof, whether hosted or made available locally or
                          remotely, to enable Tuckit to provide the Service to
                          the User.
                          <br />
                          1.3 “Service” shall mean the service of providing
                          temporary storage solutions by means of electronically
                          or mechanically controlled secure lockers at various
                          locations through the Application, to the User by
                          Tuckit as per these Terms.
                          <br />
                          ...
                          <br />
                          <b>
                            3. THE USER, WHILE ACCESSING OR USING THE
                            APPLICATION AND SERVICE, MUST FOLLOW AND ABIDE BY
                            THE APPLICABLE LAWS. IN THE EVENT OF THE USER BEING
                            FOUND TO BE NOT ELIGIBLE AS PER THE APPLICABLE LAWS,
                            TUCKIT RESERVES THE RIGHT TO DENY THE APPLICATION
                            AND SERVICE. NOTWITHSTANDING THE FOREGOING, TUCKIT
                            AT ALL TIMES RESERVES THE RIGHT TO DENY THE
                            APPLICATION AND SERVICE TO THE USER.CONSENT TO THE
                            TERMS{" "}
                          </b>{" "}
                          3.1 By clicking on the tab/button/checkbox of “Accept”
                          or any other tab/button/checkbox of similar nature,
                          subject to providing any information mandatorily
                          required by the Application or Service, (i) You
                          confirm your eligibility under Applicable Law to
                          contract with Tuckit, (ii) you accept these Terms and
                          the Privacy Policy as displayed on the Application,
                          (iii) You consent to receive communications and
                          ...
                          You must: <br />
                          a. Only open one Account using Your Registration Data,
                          and not use the account of any person <br />
                          b. provide your own electronic device (including
                          mobile phone), which must have a functioning mobile
                          number and the ability to read Our text messages
                          (SMS), OTP (One Time Password) and push notifications,
                          and meet the minimum device requirements we specify
                          from time to time (Device). <br /> c. have to keep
                          your account and registration details current and
                          correct for communications. By agreeing to the terms
                          and conditions, the User agrees to receive promotional
                          communication and newsletters upon registration. The
                          User can opt out either by unsubscribing by contacting
                          ...
                          Password) or using a Passkey in case the Users stores
                          ...
                          nuisance to Tuckit or to any of its customers use the
                          Application and Service to cause nuisance, annoyance
                          or inconvenience;
                          <br />
                          ...
                          <br />
                          (vi) reverse engineer or access the Application and
                          ...
                          <br />
                          (vii) launch an automated program or script,
                          ...
                          Application and Service;
                          <br />
                          (viii) try to harm the Application and Service in any
                          way whatsoever;
                          <br />
                          (ix) disclose information designated as confidential
                          by Tuckit, without Tuckit’s prior written consent; and
                          <br />
                          ...
                          <br />
                          9.3 At the time of using the Service, You hereby agree
                          that:
                          <br />
                          (i) You will not use lockers that have been left open
                          by a previous user;
                          <br />
                          (ii) You will scan the QR code from Your mobile device
                          with Google Lens, Chrome, or camera for a new booking;
                          <br />
                          (iii) Enable Your location on Your mobile device for
                          GPS access;
                          <br />
                          (iv) You will keep the Application open post the
                          Payment made by You, until the locker door opens;
                          <br />
                          (v) In the event the locker door doesn’t open, please
                          contact us at 7204076777.
                          <br />
                          9.4 Further, You agree that:
                          <br />
                          (i) You shall avail the Services as per the Rate Chart
                          provided on the sticker on display at the location of
                          the locker. You agree that in the event You may choose
                          to extend the time beyond the time provided on the
                          sticker, you may inform us at by contacting our
                          customer care at 7204076777;
                          <br />
                          (ii) The maximum time limit for which You shall be
                          allowed to store your belongings in the locker shall
                          be for a period of 72 (seventy-two) hours, post which
                          we will reach out to you via phone call or text
                          message, stating that your belongings will be taken
                          under our safe custody at our nearest User support
                          location;
                          <br />
                          (iii) In the event the location of the locker is in a
                          location being malls, airports, railway station, metro
                          station, or any public establishment, Your belongings
                          will be in the safe custody of such establishments’
                          lost and found department in the event the locker is
                          in a mall premises, and the same will be intimated to
                          You by way of a Whatsapp or via phone call, or text
                          message.
                          <br />
                          You are solely responsible for any breach of your
                          obligations under these Terms (including financial
                          obligations) and for the consequences (including any
                          loss or damage which Tuckit may suffer) as a result
                          any such breach. You agree to defend, indemnify and
                          hold harmless Tuckit, its employees, directors,
                          ...
                          liability to Tuckit or any third party including but
                          not limited to breach of any warranties,
                          representations or undertakings or in relation to the
                          non-fulfilment of any of your obligations under this
                          User Agreement or arising out of the your violation of
                          any applicable laws, regulations including but not
                          limited to Intellectual Property Rights, payment of
                          ...
                          shall survive the expiry or termination of this User
                          Agreement. Further, in the event You are not a
                          registered User with our website or Application (as
                          the case may be), we shall in no event be held
                          responsible for any of your belongings that You may
                          leave in and around our locker storage facility, and
                          that we shall not be liable to compensate you from and
                          against any and all claims, liabilities, damages,
                          losses, costs and expenses caused by or arising out of
                          claims based upon your actions or inactions, which may
                          result in any loss or liability incurred by you.
                          <br />
                          9.5 Payment Conditions
                          <br />
                          (i) The access to the Service is granted on ‘pre-paid’
                          and ‘post-paid’ basis. The charges as applicable from
                          time to time, shall be displayed on the interface
                          provided by Tuckit and the same shall be [exclusive /
                          ...
                          Tuckit or Unified Payments Interface (UPI). In the
                          event any other payment options are integrated with
                          the Application or the Service, such payments option
                          shall be made available to the User at the discretion
                          of Tuckit.
                          <br />
                          (iv) Tuckit reserves the rights to proceed against you
                          ...
                          <br />
                          9.7 The User shall be allowed to access the Service to
                          keep the items under storage for not more than 24
                          consecutive hours, at one instance (“Time Limit”). The
                          User shall be allowed to access the Service for
                          storage/keep and for retrieval/take/pick-up/retrieve,
                          within the Time Limit. The User shall have the option
                          to: (a) extend the Time Limit by making payment for
                          the extended Time Limit, before each instance of such
                          expiry; or (b) retrieve the items placed under storage
                          upon making payment for the Time Limit or the extended
                          Time Limit, as the case may be. In the event the User
                          fails to extend the Time Limit and retrieve the items
                          placed under storage, Tuckit shall allow the use of
                          Service for storage of items up to a maximum of 72
                          (seventy two) consecutive hours from the last Alert
                          sent to the User (“Additional Time Limit”) and the
                          User shall have the option to retrieve the items
                          placed under storage within the Additional Time Limit
                          upon making payment for the actual hours of usage of
                          the Service.
                          <br />
                          9.8 In the event the User keeps the items in storage
                          under the Service, for a period exceeding the
                          Additional Time Limit, Tuckit shall contact the User
                          and provide the User with the following options – (a)
                          removal of the items from the Service and retention of
                          custody of the same by Tuckit for the purpose of
                          collection of such items by the User at a later date
                          as agreed by Tuckit and subject to an additional
                          retrieval charge or (b) disposal of the items under
                          storage, by Tuckit without any liability whatsoever to
                          the User. Any failure on part of the User to elect the
                          aforementioned options (a) and (b) within the
                          prescribed time period, shall be deemed to be an
                          authorization to Tuckit for disposal of the items
                          under storage, by Tuckit without any liability
                          whatsoever to the User.
                          <br />
                          9.9 In the event the User makes a booking for the
                          Service and chooses the retrieve option, intentionally
                          or unintentionally, and does not recollect his/her
                          belongings, as such the Service stands terminated, and
                          Tuckit shall not be responsible for the User’s
                          belongings. Further, once the retrieve option is
                          selected by the User, the locker gets released for
                          fresh bookings, therefore if the previous User’s
                          belongings are still in the locker, and if the new
                          User steals or misplaces the previous User’s
                          belongings, Tuckit shall not be held responsible for
                          the same.
                          <br />
                          9.10 The applicable charges (except the additional
                          retrieval charge) for access to the Service shall on
                          hourly basis on such rates as displayed by Tuckit on
                          the interface provided to the User, from time to time,
                          regardless of the actual time of usage of the Service.
                          <br />
                          9.11 The User shall not be entitled to any refund for
                          retrieval of the items under storage within the Time
                          Limit or Additional Time Limit, as the case may be.
                          <br />
                          9.12 Each User shall be allocated single locker at a
                          time as a part of the Service, and such User shall be
                          not be allowed to place items larger than the
                          dimensions of the locker storage in such locker.
                          <br />
                          9.13 The User shall authorize to use only the locker
                          allocated to the User as a part of the Service and
                          Tuckit shall not be liable for loss of or damage to
                          items placed in a locker not allocated to the User.
                          <br />
                          9.14 The User shall be solely responsible for
                          closing/locking the locker after placing items under
                          storage and Tuckit shall not be liable for loss of or
                          damage to items placed in a locker if the User fails
                          to close/lock the locker after placing items under
                          storage.
                          <br />
                          9.15 Tuckit reserves the right to immediately
                          terminate the Service and the use of the Application,
                          should you not comply with any of the above terms.
                          <br />
                          9.16 In the event the User is unable to access the
                          ...
                          attributable to Tuckit, the User may contact Tuckit’s
                          customer care at 7204076777.
                          <br />
                          <b>
                          ...
                          e.g. temperature or humidity control) for the amount
                          ...
                          in contravention of these terms and Applicable Laws.
                          The User agrees not to damage or cause harm to the
                          Service or any components or elements comprised in the
                          Service and Application or abandon the items placed in
                          storage under the Service and holds Tuckit harmless in
                          respect of the said items and indemnifies Tuckit in
                          respect of any costs or liability arising upon Tuckit
                          due to misuse of the Service or abandonment of items
                          placed in storage under the Service or from any damage
                          or harm to the Service and the Application or any
                          components or elements comprised in the Service and
                          the Application. Tuckit may communicate or contact the
                          User in the event of abandonment of the Service or
                          items placed in storage under the Service, not more
                          than two times and if there is no response from the
                          User, Tuckit shall not be liable for the items placed
                          in storage under the Service.
                          <br />
                          ...
                          submission of the correct OTP to Tuckit by the User
                          and payment of amounts due, if any, by the User.
                          <br />
                          ...
                          <br />
                          <b>20. GOVERNING LAW AND JURISDICTION </b> These
                          Terms, all transactions executed hereunder, and the
                          legal relations between the Parties shall be governed
                          and construed solely in accordance with the laws of
                          India and the courts of Bengaluru shall have exclusive
                          jurisdiction.
                          <br />
                          <b>21. ENTIRE AGREEMENT </b>
                          These Terms along with the Privacy Policy available at
                          www.tuckit.in, constitute the complete and exclusive
                          ...
                          <br />
                          <b>23. CHANGES TO THE TERMS </b> Tuckit may vary or
                          amend, modify, or change the Terms at its discretion
                          and without any notice or cause, at any time,
                          periodically, without the Users consent. By continuing
                          to use any Service after any amendment, modification,
                          or change, the User has agreed to be bound by all such
