...
const SeatbookingNXSNKNupdated = () => {
  const Auth = useAuth();

  const [lockerDetails, setLockerDetails] = useState({
    seat: lockers.NXSNKNB,
    ...
    // seatNoA: ["S1", "S5", "S8", "L11"],
    // seatNoB: ["S2", "QR", "L12"],
    // seatNoc: ["M3", "M6", "M9", "L13"],
    // seatNoD: ["L14"],
    // seatNoE: ["M4", "M7", "M10"],
    // seatNoF: ["L15"],
          ...
          <div className="grid-container">
            ...
            <div className="garuda-layout-container">
              ...
              <div className="second-column">
                ...
                {/* <button className="qr-container locker-common-des">QR</button> */}
...
export default SeatbookingNXSNKNupdated;
